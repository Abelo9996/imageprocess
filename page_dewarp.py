...
def remap_image(name, img, small, page_dims, params):
    ...
    threshfile = 'jpg_png/' + name + '_thresh.png'
...
def main():
    ...
    mypath = "C:/Users/Abel/Desktop/page_dewarp-master/example_input"
    onlyfiles = ["example_input/"+f for f in listdir(mypath) if isfile(join(mypath, f))]
    for imgfile in onlyfiles:
        ...
        print ('  wrote', outfile)
        print()
        img_path = "C:/Users/Abel/Desktop/page_dewarp-master/" +''.join(outfile)
        pdf_path = "C:/Users/Abel/Desktop/page_dewarp-master/pdf"+''.join(outfile[7:-4])+".pdf"
